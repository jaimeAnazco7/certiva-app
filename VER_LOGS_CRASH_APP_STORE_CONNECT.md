...
1. **El tester aún no ha hecho clic en "Compartir"**
   - Los logs solo aparecen cuando el tester hace clic en "Compartir"
   - **Solución:** Pide al tester que haga clic en "Compartir" cuando aparezca el error

2. **Los logs pueden tardar unos minutos en aparecer**
   - A veces tarda 5-15 minutos después de que el tester comparte
